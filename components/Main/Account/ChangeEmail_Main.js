...
const Custom401_Main = dynamic(() => import("../Errors/Custom401_Main"))

export default function ChangeEmail_Main(props) {
  /********** PROPS **********/
  const {} = props
  ...
  if (!token || (!emailChanged && error)) return <Custom401_Main />
