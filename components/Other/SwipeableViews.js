  ...
  (function (_React$Component) {
    ...
    function SwipeableViews(props) {
      ...
      _this = (0, _possibleConstructorReturn2.default)(
        this,
        (0, _getPrototypeOf2.default)(SwipeableViews).call(this, props)
      )
      _this.rootNode = null
      ...
      _this.handleSwipeStart = function (event) {
        ...
        _this.viewLength =
          _this.rootNode.getBoundingClientRect()[axisProperties.length[axis]]
      ...
      _this.handleSwipeMove = function (event) {
        ...
        if (_this.isSwiping === undefined) {
          ...
          var isSwiping =
            dx > dy &&
            dx > _reactSwipeableViewsCore.constant.UNCERTAINTY_THRESHOLD // We let the parent handle the scroll.
          ...
          if (
            ...
            ((_this.indexCurrent === 0 && _this.startX < touch.pageX) ||
              (_this.indexCurrent ===
                React.Children.count(_this.props.children) - 1 &&
                _this.startX > touch.pageX))
          ) {
          ...
          if (
            isSwiping === true ||
            dy > _reactSwipeableViewsCore.constant.UNCERTAINTY_THRESHOLD
          ) {
      ...
      _this.handleSwipeEnd = function () {
        ...
        if (Math.abs(_this.vx) > _this.props.threshold) {
          ...
          indexNew =
            delta > 0 ? Math.floor(indexCurrent) : Math.ceil(indexCurrent)
        } else {
        ...
        value: function UNSAFE_componentWillReceiveProps(nextProps) {
          ...
          if (typeof index === "number" && index !== this.props.index) {
            ...
            this.setState({
              ...
              displaySameSlide: (0,
              _reactSwipeableViewsCore.getDisplaySameSlide)(
                this.props,
                nextProps
              ),
              indexLatest: index,
      ...
      },
      {
        ...
        value: function render() {
          ...
          process.env.NODE_ENV !== "production"
            ...
            : void 0
          var slideStyle = (0, _extends2.default)(
            {},
            styles.slide,
            slideStyleProp
          )
          ...
          if (isDragging || !animateTransitions || displaySameSlide) {
            ...
            WebkitTransition = createTransition(
              "-webkit-transform",
              springConfig
            )

            if (heightLatest !== 0) {
              var additionalTranstion = ", ".concat(
                createTransition("height", springConfig)
              )
          ...
          if (!renderOnlyActive) {
            var transform = axisProperties.transform[axis](
              this.indexCurrent * 100
            )
